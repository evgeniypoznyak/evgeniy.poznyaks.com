        ...
        <div class="container">    <!-- Portfolio Item Row -->
            <div class="row vertical-align">
                        ...
                        <div class="carousel-inner">
                            @foreach($pictures as $key => $picture)
                                ...
                                <div class="item @if($key == 0) active @endif">
                                    <img class="img-responsive swipe-now" src="/img/{{$picture->picture}}" alt="">
                                </div>
                            @endforeach
                ...
                <div class="col-md-4">
                    ...
                    <p>{!! $picture->project->details !!}</p>

                    <div style="text-align: right">
                        <a href="{{$picture->project->url}}" target="_blank">{{$picture->project->title}}</a>
                    </div>
